...
public class FlatsService {
  ...
  public void deleteFlat(String flatname) {
    if (!dbFlatsRepository.existsById(flatname)) {
      throw new NotFoundException("Flat not found: " + flatname);
    }
    dbFlatsRepository.deleteById(flatname);
  }
}
